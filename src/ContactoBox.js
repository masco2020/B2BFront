...
import { Platform, StyleSheet, TouchableNativeFeedback, Modal, ScrollView } from 'react-native';
            ...
            <CardItem style={[styles.contactoCardsItems]}>
                <Body style={[styles.contactoCardsBody]}>
                    <View style={[styles.contactoCardTop]} >
                        ...
                        <ScrollView  style={[styles.contactCargoScroll]}  horizontal={true} contentInset>
