...
import { Text, View, Form, Button, Icon, Body, Content, List, ListItem, Root,} from 'native-base'
        ...
        <Form style={[estilo.formFicha]}>
            <List style={[estilo.listFicha]} >
              <ListItem style={[estilo.listItemFicha]} >
                  <Body style={[estilo.itemBodyFicha]} >
                      <Text style={[estilo.tittleFicha]}  note>Tipo de Cliente</Text>
                      <Text style={[estilo.dateFicha]}  >{empresasHData.tipoCliente}</Text>
                  </Body>
              </ListItem>
              <ListItem style={[estilo.listItemFicha]}>
                  <Body style={[estilo.itemBodyFicha]}>
                      <Text style={[estilo.tittleFicha]} note>Nombre Comercial</Text>
                      <Text style={[estilo.dateFicha]}>{empresasHData.nombre}</Text>
                  </Body>
              </ListItem>
              <ListItem style={[estilo.listItemFicha]}>
                  <Body style={[estilo.itemBodyFicha]}>
                      <Text style={[estilo.tittleFicha]} note>Razón Social</Text>
                      <Text style={[estilo.dateFicha]}>{empresasHData.razonSocial}</Text>
                  </Body>
              </ListItem>
              <ListItem style={[estilo.listItemFicha]}>
                  <Body style={[estilo.itemBodyFicha]}>
          ...
          <List style={[estilo.listFicha]} >
              <ListItem style={[estilo.listItemFicha]}>
                  <Body style={[estilo.itemBodyFicha]}>
                      <Text style={[estilo.tittleFicha]} note>Pais</Text>
                      <Text style={[estilo.dateFicha]}>Chile</Text>
                  </Body>
              </ListItem>
              <ListItem style={[estilo.listItemFicha]} >
                  <Body style={[estilo.itemBodyFicha]} >
          ...
          <List style={[estilo.listFicha]} >
              <ListItem style={[estilo.listItemFicha]} >
                  <Body style={[estilo.itemBodyFicha]} >
                      <Text style={[estilo.tittleFicha]}  note>Nº Telefonico Empresarial</Text>
                      <Text style={[estilo.dateFicha]}  >{empresasHData.telefonoEmpresarial}</Text>
                  </Body>
              </ListItem>
              <ListItem style={[estilo.listItemFicha, estilo.listItemFichaContac]}>
                  <Body style={[estilo.itemBodyFicha]}>
                      <Text style={[estilo.tittleFicha]} note>Correo Empresarial</Text>
                      <Text style={[estilo.dateFicha]}>{empresasHData.correoEmpresarial}</Text>
                  </Body>
              </ListItem>
          </List>
        </Form>
